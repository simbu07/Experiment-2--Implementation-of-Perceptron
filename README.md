...
5. Define the input vector ‘X’ from the training dataset.
6. Define the desired output vector ‘Y’ scaled to +1 or -1 for two classes C1 and C2.
7. Assign Initial Weight vector ‘W’ as 0 as the dimension of ‘X’.
8. Assign the learning rate.
9. For ‘N ‘ iterations ,do the following:
        v(i) = w(i)*x(i)
